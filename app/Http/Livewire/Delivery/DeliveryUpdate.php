...
class DeliveryUpdate extends Component
{
    ...
    {
        return view('livewire.delivery.delivery-update');
    }

    
    public function mount($slug)
    {
        $this->basketManagements = BasketManagement::all();
    ...
    public function submit()
    {
        ...
        $this->basketmunicipality=MunicipalityBasket::where('id', $this->basket_management_id)->firstOrFail();
    ...
    public function onChangeSelectBasketManagement()
    {
        $this->basketManagements = BasketManagement::all();
    }
