...
class BeneficiaryUpdateState extends Component
{
    use LivewireAlert;
    public $slug;
    public $data;
    ...
    {
        return view('livewire.beneficiary.beneficiary-update-state');
    }
    ...
    {
        return redirect()->route('beneficiary.beneficiary-update-state', [$this->beneficiary->slug]);
    }
}
