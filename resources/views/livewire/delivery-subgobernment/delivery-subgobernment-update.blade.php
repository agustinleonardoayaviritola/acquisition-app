<div>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">
            {{-- select district --}}
{{--             <div>
                <x-jet-label class="mt-4 text-sm" for="municipality_basket_id" value="{{ __('Gestion ') }}" />
                <select wire:model="municipality_basket_id" wire:change="onChangeSelectBasketManagement"
                    ...
                    @forelse ($basketManagements as $district)
            ...
            {{-- select basket --}}
            <div>
                <x-jet-label class="mt-4 text-sm" for="basket_id" value="{{ __('Canasta') }}" />
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="mt-4 text-sm">
                    <label for="number_baskets"> Número de Canastas asignadas</label>
                </div>
                <x-jet-input type="number" placeholder="Número de Canastas" wire:model="number_baskets"
                    class="mt-1 block w-full rounded-rm" required disabled/>
            ...
            <div class="col-span-1 md:col-span-1">
                {{-- select month --}}
                <div class="mt-4 text-sm">
                    <label for="document_issuance"> Mes de incio de entrega</label>
                </div>
