<div>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="pt-10 px-10">
            <h1 class=" text-2xl font-bold">Actualizar departamento</h1>
        </div>
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">

            {{-- select Departamento --}}
            <div>
                <x-jet-label class="mt-4 text-sm" for="country_id" value="{{ __('País') }}" />
                <select wire:model="country_id" wire:change="onChangeSelectCountrie"
