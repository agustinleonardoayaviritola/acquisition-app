<div>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">
            ...
            {{-- price --}}
            <div class="mt-4 text-sm">
                <label for="amount"></i> Precio de compra</label>
            </div>
            <x-jet-input type="number" step="any" placeholder="Precio de compra" wire:model="amount"
                pattern="^\d*(\.\d{0,2})?$" class="mt-1 block w-full rounded-rm" />
            @error('amount')
                <p class="text-red-500 font-semibold my-2">
                    {{ $message }}
                </p>
