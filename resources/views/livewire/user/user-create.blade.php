<div>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">
            ...
            <div>
                <x-jet-label class="mt-4 text-sm" for="subgovernment_code" value="{{ __('Para que Sub Gobernacion') }}" />
                <select wire:model="subgovernment_code" wire:change="onChangeSelectSubgovernment"
                    class="border-gray-300 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 shadow-sm mt-1 block w-full rounded-fx"
                    required>

                    <option selected>(Seleccionar)</option>
                    @forelse ($subgovernments as $subgovernment)
                        <option value="{{ $subgovernment->slug }}">
