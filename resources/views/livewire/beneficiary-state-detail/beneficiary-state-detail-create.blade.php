<div>
    <x-slot name="header">
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            Registrar el Detalle Estado de Beneficiario
        </div>
    </x-slot>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="pt-10 px-10">
            <h1 class=" text-2xl font-bold">Crear Detalle de Estado</h1>
        </div>
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">
         ...
         <div class="mt-4 text-sm">
            ...
            <x-jet-input onkeyup="this.value = this.value.toUpperCase();" type="text" placeholder="Descripcion"
